                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800"><?php echo e($stats['total']); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800"><?php echo e(\Rulr\Mailpot\Support\Statistics::formatBytes($stats['total_size'])); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800"><?php echo e(\Rulr\Mailpot\Support\Statistics::formatBytes($stats['largest'])); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800"><?php echo e(\Rulr\Mailpot\Support\Statistics::formatBytes($stats['smallest'])); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-2 flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800"><?php echo e($stats['last_updated']); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
...
<?php /**PATH C:\Users\Admin\Desktop\payyigi-api\vendor\rulr\laravel-mailpot\src/../resources/views/inbox.blade.php ENDPATH**/ ?>